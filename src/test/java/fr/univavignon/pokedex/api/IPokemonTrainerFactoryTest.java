...
public class IPokemonTrainerFactoryTest {
    ...
    public void testCreateTrainerReturnsExpectedTrainer() {
        ...
        PokemonTrainer trainer = trainerFactory.createTrainer("Merly", Team.MYSTIC, pokedexFactory);
    ...
    public void testCreateTrainerWithExistingNameThrowsException() {
        when(trainerFactory.createTrainer("Maryem", Team.VALOR, pokedexFactory)).thenThrow(new IllegalStateException("Trainer already exists."));
        assertThrows(IllegalStateException.class, () -> trainerFactory.createTrainer("Maryem", Team.VALOR, pokedexFactory), "Should throw exception when creating a trainer with an existing name.");
    }
